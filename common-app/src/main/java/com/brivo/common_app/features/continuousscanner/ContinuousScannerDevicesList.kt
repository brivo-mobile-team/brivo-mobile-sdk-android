...
@Composable
fun ContinuousScannerDevicesList(
    continuousScannerUIState: ContinuousScannerUIState,
    ...
    if (discoveredPeripherals.isEmpty() || continuousScannerUIState == ContinuousScannerUIState.BLE_OFF) {
        Box(
            modifier = Modifier
                .fillMaxSize()
                .padding(32.dp),
            ...
            val text =
                if (continuousScannerUIState == ContinuousScannerUIState.BLE_OFF) R.string.continuous_scanner_ble_turned_off
                else R.string.continuous_scanner_access_points_not_found
            Text(
...
@Composable
fun ContinuousScannerDevicesListPreview() {
    MaterialTheme {
        ContinuousScannerDevicesList(
            ...
            continuousScannerUIState = ContinuousScannerUIState.SCANNING,
...
@Preview(showBackground = true)
@Composable
fun ContinuousScannerDevicesListEmptyPreview() {
    MaterialTheme {
        ContinuousScannerDevicesList(
